...
public class QuizController {
    ...
    private void Quizdata(int counter) {
    ...
    public boolean Quizdata(String answer) {
    ...
    public void opt1clicked(ActionEvent event) {
        Quizdata(opt1.getText().toString());
        if (Quizdata(opt1.getText().toString())) {
            correct = correct + 1;
        } else {
            wrong = wrong + 1;
        }
    ...
    public void opt2clicked(ActionEvent event) {
        Quizdata(opt2.getText().toString());
        if (Quizdata(opt2.getText().toString())) {
            correct = correct + 1;
        } else {
            wrong = wrong + 1;
        }
    ...
    public void opt3clicked(ActionEvent event) {
        Quizdata(opt3.getText().toString());
        if (Quizdata(opt3.getText().toString())) {
            correct = correct + 1;
        } else {
            wrong = wrong + 1;
        }
    ...
    public void opt4clicked(ActionEvent event) {
        Quizdata(opt4.getText().toString());
        if (Quizdata(opt4.getText().toString())) {
            correct = correct + 1;
        } else {
            wrong = wrong + 1;
        }
